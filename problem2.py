one = ['', 'Bir', 'İki', 'Üç', 'Dörd', 'Beş', 'Altı', 'Yeddi', 'Sekkiz', 'Doqquz']
tenp = ['On', 'On bir', 'On iki', 'On üç', 'On dörd', 'On beş', 'On altı', 'On yeddi', 'On sekkiz', 'On doqquz']
tenp2 = ['', '', 'İyirmi', 'Otuz', 'Qırx', 'Elli', 'Altmış', 'Yetmiş', 'Seksen', 'Doxsan']
